    ...
    >
      ...
      <div className='grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
        {projects.map((project) => (
            ...
            className='border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-[#006666]
                ...
                <div className='p-6'>
                    ...
                    <div className='mb-4'>
                        {project.tags.map((tag, index) => (
                            <span
                            key={index}
                            className='inline-block bg-[#004d4d] text-xs font-semibold text-[#00cccc] rounded-full px-2 py-1 mr-2 mb-2'
                            >
                                {tag}
                            </span>
                        ))}
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/95 p-4'>
            <div className='bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative'>
                <div className='flex justify-end p-4'>
                    ...
                    className='text-white text-3xl font-bold hover:text-[#006666]'
                    >
                        &times;
                    </button>
                </div>
                    ...
                    <div className='lg:p-8 p-6'>
                        ...
                        <div className='flex flex-wrap gap-2 mb-6'>
                            {selectedProject.tags.map((tag,index) => (
                                <span
                            key={index}
                            className='bg-[#004d4d] text-xs font-semibold text-[#00cccc] rounded-full px-2 py-1'
                            >
                                {tag}
                            </span>
                            ))}
                        ...
                        <div className='flex gap-4 mb-2'>
                            ...
                            className='w-full bg-gray-800 hover:bg-[#006666] text-gray-400 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center'>
                                View Code
                            </a>
                        </div>
